//
//  ContainerNotiticationDetailFloatingViewController.swift
//  MamNon
//
...
class ContainerNotiticationDetailFloatingViewController: UIViewController,FloatingPanelControllerDelegate {
    ...
    func initFloating(){
        ...
        let contentVC =  NotiticationDetailViewController()
        contentVC.objNotifi = objNotifi
        contentVC.delegate = self
        fpc.set(contentViewController: contentVC)

        // Track a scroll view(or the siblings) in the content view controller.
        fpc.track(scrollView: contentVC.tabelView)
    ...
    func floatingPanel(_ vc: FloatingPanelController, layoutFor newCollection: UITraitCollection) -> FloatingPanelLayout? {
        return NotiticationDetailFloatingPanelLayout()
    }

}

class NotiticationDetailFloatingPanelLayout: FloatingPanelLayout {
    ...
    public func insetFor(position: FloatingPanelPosition) -> CGFloat? {
        switch position {
        case .full: return  150// A top inset from safe area
...
extension ContainerNotiticationDetailFloatingViewController: NotiticationDetailViewControllerDelegate{
    func closeView() {
        fpc.move(to: .tip, animated: true) {
            self.dismiss(animated: false)
        }
